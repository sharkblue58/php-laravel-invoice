                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2">
                                                                        ...
                                                                        <a class="btn btn-outline-success btn-sm"
                                                                            href="{{route('file.view',[$invoices->invoice_number,$attachment->file_name])}}"
                                                                            role="button"><i class="fas fa-eye"></i>&nbsp;
                                                                            عرض</a>

                                                                        <a class="btn btn-outline-info btn-sm"
                                                                            href="{{route('file.download',[$invoices->invoice_number,$attachment->file_name])}}"
                                                                            role="button"><i
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('file.delete') }}" method="post">
                    ...
                    <div class="modal-body">
                        <p class="text-center">
                        <h6 class="text-red font-weight-bold "> هل انت متاكد من عملية حذف المرفق ؟</h6>
                        </p>
